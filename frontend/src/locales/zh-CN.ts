export default {
  ...
  admin: {
    ...
    siteUsers: {
      title: '站点用户',
      subtitle: '浏览 admin 站点用户，按充值流水标记赠送/返利/付费，驱动营收侧余额。',
      refresh: '刷新',
      needAdmin: '请先登录仪表盘 admin 账户',
      needAdminHelp: '站点用户数据来自当前工作区 admin 会话（与仪表盘同一登录）。',
      searchPlaceholder: '搜索邮箱、用户 ID 或用户名…',
      search: '搜索',
      hideExcludedOn: '已隐藏排除用户',
      hideExcludedOff: '显示排除用户',
      listTitle: '用户列表',
      total: '共 {count} 人',
      empty: '暂无用户，或搜索无结果。',
      selectHint: '从左侧选择用户，或搜索后点候选，查看并标记充值记录。',
      balance: '余额',
      notes: '备注',
      lastUsed: '最后使用',
      neverUsed: '从未使用',
      jumpPage: '跳转',
      pageLabel: '第',
      loadingTopups: '加载入账记录…',
      nonRevenueHint: '营收侧已扣 {value}（赠送+返利标记）',
      listGiftRebate: '赠送/返利 ',
      listRechargeTotal: '累计充值 ',
      topupHelp: '正向：返利→返利，明确赠送→赠送，其余→充值。负向扣款默认不自动归类（可能是充值退款或赠送收回），请手动点「充值退款 / 赠送收回 / 返利收回」；同一标签下金额可正可负，合计为净额。并发/RPM 不出现。',
      platformLifetime: '平台累计充值',
      detailSum: '明细合计',
      giftRebate: '赠送+返利',
      topupEmpty: '暂无入账流水',
      suggested: '建议：{tag}',
      ...
      usage: {
        title: '用量详情',
        detailBtn: '详情',
        help: '按分组统计该用户今日与历史实际消费（平台额度），占比为各分组占本区间合计的百分比。',
        today: '今日使用',
        history: '历史使用',
        total: '合计',
        empty: '该区间暂无用量',
      ...
      errors: {
        network: '网络请求失败',
        request: '请求失败，请稍后重试',
        platformUnsupported: '当前 admin 平台不支持站点用户流水（需 Sub2API）。',
        historyUnavailable: '无法拉取该用户充值流水，请确认 admin 会话有效。',
        usageUnavailable: '无法拉取该用户用量，请确认 admin 会话有效。',
        invalidUser: '无效用户',
        invalidRequest: '无效请求',
        invalidTag: '无效标签',
        invalidAmount: '无效金额',
        invalidRate: '请输入有效的充值倍率（大于 0）',
      },
    },
    siteBalance: {
      title: '站点用户余额',
      subtitle: '按余额排序查看用户；成本口径 = 平台余额 × 站点充值倍率。',
      rechargeRate: '充值倍率',
      rechargeRateHelp: '平台 1 单位余额 = 右侧数字成本/CNY，保存后写入仪表盘站点用户总余额。',
      excludeAdmin: '排除管理员',
      excludeUsers: '排除指定用户',
      excludeUsersHelp: '测试号等整户不计入站点用户余额与付费剩余；列表中也隐藏。可搜邮箱/ID 添加。',
      excludeUsersPlaceholder: '邮箱、用户 ID 或用户名…',
      saveSettings: '保存',
      pageCost: '本页兑付余额合计',
      pageRecharge: '本页累计充值合计',
      rateLabel: '当前倍率',
      colUser: '用户',
      colBalance: '平台余额',
      colBalanceCny: '兑付余额',
      colRechargeTotal: '累计充值',
      colGift: '累计赠送',
      colRebate: '累计返利',
      colAction: '操作',
      markLedger: '标记流水',
    ...
    dashboard: {
      ...
      capital: {
        ...
        coverage: '余额覆盖率',
        coverageHint: '预存备付 ÷ 兑付余额（用户当前余额合计，含赠送剩余；预授信账面不计入分子）。无用户余额时不适用。',
        creditReferenceHint: '预授信站平台账面参考合计：{value}（不进覆盖率）',
        runway: '预计续航',
      ...
      groupProfit: {
        ...
        subtitle: '{ownCount} 个自有分组 · 净利润 {profit} · 利润率 {margin}',
        hint: '今日营收合计 {revenue}。自有：管理站分组真实营收 − 上游 key 成本。上游子行：成本=key 实耗；营收优先=真实对接管理站账号/channel 今日消费；无对接则成本分摊（实际利润率会等于母行）。利润率主行=实际；次行「预算」=售卖/成本倍率理论值，用于对照。',
        revenueSourceAccount: '账号真实',
        revenueSourceAllocated: '成本分摊',
        budgetMargin: '预算 {margin}',
        actualMarginLabel: '实际 {margin}',
        actualMarginHint: '实际',
        allocatedMarginHint: '成本分摊时实际利润率等于母行；主数字为预算利润率（售卖/成本倍率）',
        probeCost: '含探测 {cost}',
        expand: '展开上游',
        collapse: '收起上游',
        upstreamCount: '{count} 个上游',
        unmappedTitle: '未映射上游',
        unmappedHint: '今日有消耗但未映射到任何自有分组的上游，仅计成本、无对应管理站营收。',
        upstreamPartial: '部分上游站点用量暂时无法读取，上游列表可能不完整。',
      ...
      todayInbound: {
        ...
        empty: '今日尚无进货：预存站请在「进货」标记充值；预授信站请在「登记结算」记线下付款。',
        loadError: '加载今日进货明细失败。',
        colSite: '上游站点',
        colPlatform: '平台',
        colEntries: '笔数',
        colAmount: '成本金额',
      ...
      balanceFilter: {
        title: '余额筛选条件',
        subtitle: '成本侧含赠送/返利；营收侧可扣除赠送额度。整户排除则两侧都不计。',
        close: '关闭',
        ...
        excludeUserIds: '整户排除（用户 ID）',
        excludeUserIdsHelp: '测试号等：成本与营收都不计入。',
        userIdPlaceholder: '用户 ID',
        userGifts: '赠送不计营收额度（手调）',
        userGiftsHelp: '只从营收侧扣除。推荐在「站点用户」里按充值流水标记赠送/返利（自动识别）；此处为额外手调上限。与流水标记取较大值。',
        giftAmountPlaceholder: '赠送额度',
        siteUsersLink: '去站点用户标记流水',
        add: '添加',
        cancel: '取消',
        save: '保存',
        saving: '保存中...',
    ...
    connectionHealth: {
      ...
      groupDetail: {
        ...
        probeAutomation: '立即策略探活',
        probeAutomationRunning: '正在探活…',
        probeAutomationHint: '对当前分组内已纳入监控的账号/渠道立即跑一轮完整策略探活（写状态/事件，可触发自动降级与远端动作）',
        probeAutomationResult: '整组探活完成：成功 {probed}，跳过 {skipped}，失败 {failed}（共 {total} 个账号/渠道）',
        unmonitored: '未纳入自动监控',
        ...
        metrics: {
          ...
          lastProbe: '最近探活',
          todaySpend: '今日消耗',
          todayProbeCost: '今日探测消耗',
          todayProbeCostHint: '本分组今日真实探活费用合计（按上游倍率/响应 actual_cost 记账，非估算费率）'
        },
        statusBreakdown: {
          title: '当前分组探活状态',
        ...
        columns: {
          ...
          upstreamSpendHint: '该账号关联的上游 API Key 所属分组今日实际成本（同分组多 key 合计）。「我的分组」成本为映射到该组的上游 key 实耗之和。',
          upstreamSpendFor: '上游分组「{group}」今日成本',
          upstreamProfit: '上游分组利润',
          upstreamProfitHint: '该账号关联的上游分组今日利润（与净利润弹窗一致：优先管理站对接账号真实消费 − 上游 key 成本）。',
          upstreamProfitFor: '上游分组「{group}」今日利润',
          probeCost: '探测消耗',
          probeCostHint: '该账号今日真实探活费用（事件记账：优先上游 actual_cost，否则 tokens×分组倍率×充值倍率）',
          actions: '操作'
        },
      ...
      policies: {
        ...
        budgetUsage: '今日 {used}/{total} 次',
        budgetCostUsage: '费用 {used}/{total}',
        budgetCostUnlimited: '不限额',
        strategyModes: {
          health_probe: '健康探活',
      ...
      policyDrawer: {
        ...
        dailyBudgetCostLabel: '每日金额预算（CNY）',
        dailyBudgetCostUsage: '今日已消耗 {used} / 预算 {total}，剩余 {remaining}',
        dailyBudgetCostUnlimited: '不限额',
        ...
        priorityModes: {
          none: '保持上游设置',
          multiplier: '按上游成本倍率排序'
        },
        priorityModeHelp: '开启倍率排序后，系统会在健康目标中优先使用更低成本倍率的上游（优先取真实对接的上游 API Key 分组倍率）；故障状态始终优先降级。',
        ...
        tooltips: {
          ...
          dailyBudget: '单位是「次」：本策略每天最多执行多少次真实模型探活请求（按中国自然日 UTC+8 重置）。每探活一个模型计 1 次。次数预算耗尽后会跳过真实探活。',
          dailyBudgetCost: '单位是 CNY：本策略每天最多允许消耗多少真实探活费用。费用按上游响应 actual_cost 或 tokens×上游分组倍率×站点充值倍率记账（各上游 USD 口径可能不同，故预算统一用 CNY）。填 0 表示不按金额限流，但仍会统计并展示今日已消耗金额。金额预算耗尽后同样会跳过真实探活。',
      ...
      fields: {
        ...
        platform: '平台',
        balance: '余额',
        platformBalance: '平台账面',
        platformBalanceHint: '仅供参考',
        todayConsume: '今日消费',
        historyRecharge: '累计入账',
        groupName: '分组名称',
      ...
      siteSettings: {
        ...
        balanceThresholdHelp: '开启后使用站点专属阈值，关闭则使用全局默认值。可设为负数（如 -1）表示该站不触发余额预警。',
        balanceThresholdPlaceholder: '输入阈值金额，-1 表示不报警',
        settlementMode: '结算 / 备付模式',
        settlementModeHelp: '预存站余额计入覆盖率分子；预授信站平台账面仅作参考，按消耗手动结算。',
        modePrepaid: '预存余额',
        modePrepaidHelp: '真实充值，余额可作备付',
        modeCredit: '预授信结算',
        modeCreditHelp: '先用后结，平台账面≠已付款',
        creditLimit: '授信额度（成本口径）',
        creditLimitPlaceholder: '例如 10000',
        settlementCurrency: '结算币种展示',
        creditCostHint: '授信额度为充值倍率换算后的成本单位，不是上游原始 USD。',
        creditLimitNonNegative: '授信额度不能为负数',
        save: '保存',
        saveSuccess: '已保存',
        saving: '保存中...',
        cancel: '取消'
      ...
      settlement: {
        ...
        settled: '已结算',
        consumed: '累计消耗',
        creditRemaining: '剩余授信',
        platformBalanceHint: '平台账面（仅参考）：{value}',
        register: '登记一笔结算',
        amountLabel: '金额',
        amountPlaceholder: '金额',
        settledAtLabel: '结算时间',
        noteLabel: '备注',
        notePlaceholder: '备注（微信/期数等）',
        submit: '确认登记',
        manualHint: '线下付款后在此记账；系统不自动扣款。结算时间决定计入哪一天的「今日进货」。',
        history: '结算记录',
        empty: '暂无结算记录',
        void: '作废',
        voidConfirm: '确认作废该条结算记录？',
        delete: '删除',
        deleteConfirm: '确认永久删除该条结算记录？此操作不可恢复。',
        invalidAmount: '请输入有效金额',
        invalidSettledAt: '请选择有效的结算时间',
        loadingSummary: '结算汇总加载中…',
      },
      ledger: {
        title: '进货账本',
        open: '进货',
        costUnit: '成本口径',
        todayInbound: '已标记充值（成本）',
        pageInbound: '本页已标充值（成本）',
        totalRecords: '明细条数',
        unmarked: '未标记笔数',
        unmarkedPage: '本页未标 {count}',
        compareTitle: '口径对照（成本）',
        compareHint: '平台累计入账 = 卡片「历史充值」，含赠送/返利等；已标充值才计进货。两边不对齐通常因明细不全或含赠送返利。',
        platformLifetime: '平台累计入账',
        detailListSum: '明细列表合计',
        markedRechargeSum: '已标充值合计',
        markedOtherSum: '已标赠送+返利',
        gapLifetimeVsMarked: '累计入账 − 已标充值 = {value}',
        help: '按上游类型自动切换接口并全量拉取：sub2api=支付订单+兑换；new-api=充值订单。返利自动标返利，其余先标充值；赠送请手改。仅「充值」计入今日进货。前端分页展示。',
        platformRecords: '平台入账记录',
        empty: '暂无入账记录',
        historyUnavailable: '无法拉取该站入账流水：请同步后重试，或确认 new-api 有 /api/user/topup/self、sub2api 有支付/兑换接口。',
        needSession: '站点未连接，请先同步站点会话。',
        suggested: '建议：{tag}',
        tags: {
          recharge: '充值',
          gift: '赠送',
      ...
      subscriptions: {
        ...
        remaining: '剩余',
        todayMax: '今日最多可消耗',
        todayMaxHint: '取日/周/月剩余额度的最小值',
        expires: '到期',
        starts: '开通/续费',
        listSummary: '{count} 条订阅',
        listSummaryMax: '{count} 条 · 今日最多 {max} USD',
        topup: '登记进货',
        topupTitle: '订阅进货 · {name}',
        topupHint: '手填订阅实付金额（成本口径）。进货日期请用开通日或续费日，会计入该日「今日进货」，不是点登记的当天。',
        topupAmount: '实付金额（成本）',
        topupAmountPlaceholder: '例如 299',
        topupDate: '进货日期（开通/续费日）',
        topupDateHelp: '默认取订阅 startsAt；续费后若 startsAt 更新会自动换新日期。也可手动改。',
        topupNotePlaceholder: '备注（支付渠道/订单号等）',
        topupSubmit: '确认进货',
        topupInvalidAmount: '请输入有效实付金额',
        topupInvalidDate: '请填写有效的进货日期',
      },
      viewMode: {
        list: '列表模式',
        card: '卡片模式'
