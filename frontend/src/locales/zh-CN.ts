  ...
  admin: {
    ...
    dashboard: {
      ...
      groupProfit: {
        ...
        hint: '今日营收合计 {revenue}。我的分组成本 = 调价映射关联的上游 key 实耗之和（与分组健康「上游分组消耗」同源）；利润 = 营收 − 该成本。',
        upstreamHint: '仅展示今日有消耗的上游分组（key 实耗）。有调价映射时按「售卖倍率 − 成本倍率」估算利润；否则回退全站利润率。与分组健康列表「上游分组消耗/利润」同口径。',
    ...
    connectionHealth: {
      ...
      groupDetail: {
        ...
        columns: {
          ...
          upstreamProfitHint: '该账号关联的上游分组今日估算利润（与净利润弹窗「上游分组」表一致，按售卖/成本倍率估算）。',
