  ...
  admin: {
    ...
    dashboard: {
      ...
      groupProfit: {
        ...
        hint: 'Total revenue {revenue}. My-group cost = sum of linked upstream key spend via pricing maps (same basis as group-health upstream spend). Profit = revenue − that cost.',
        upstreamHint: 'Only upstream groups with spend today (key actual cost). With pricing maps, profit uses (sale − cost) multipliers; otherwise falls back to site-wide margin. Same basis as group-health upstream spend/profit columns.',
    ...
    connectionHealth: {
      ...
      groupDetail: {
        ...
        columns: {
          ...
          upstreamProfitHint: "Estimated profit for the linked upstream group (same as the Upstream groups table in net-profit detail: sale/cost multiplier).",
