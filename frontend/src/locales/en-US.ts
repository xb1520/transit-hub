    ...
    connectionHealth: {
      ...
      groupDetail: {
        ...
        columns: {
          ...
          upstreamProfitHint: "Today's estimated profit for the linked upstream group (same basis as the dashboard net-profit drill-down)",
      ...
      policyDrawer: {
        ...
        tooltips: {
          ...
          dailyBudgetCost: 'USD cost budget (cost accounting unit). Max estimated probe spend per day. 0 means no money cap, but today\'s spent amount is still tracked and shown. When the cost budget is exhausted, real probes are skipped the same way as the request budget.',
          probeCostPer1k: 'Used to estimate probe cost: prefer upstream usage tokens as cost = tokens/1000 × this rate; if the response has no usage, estimate with max_tokens+16. Default 0.002.',
